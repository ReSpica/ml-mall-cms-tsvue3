<template>
  ...
  <MlCard title="技术栈">
    ...
    <MlDescriptions title="生产环境依赖" :column="2" :table-datas="dependencies" />
    <MlDescriptions title="开发环境依赖" :column="2" :table-datas="devDependencies" />
  </MlCard>
  <MlCard title="项目结构">
    <div class="c-left">
      <MlCode language="bash" :code="projectDir" />
    </div>
  </MlCard>
  <MlCard title="项目规范">
    <MlDescriptions
...
import MlCode from '@/base-ui/code';
import MlCard from '@/base-ui/card';
import MlDescriptions from '@/base-ui/descriptions';
